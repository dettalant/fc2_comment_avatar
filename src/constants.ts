...
export namespace caConst {
  // PCでは"click"を、SPでは"touchend"をクリックイベント指定部分に用いる
  export const DEVICE_CLICK_EVENT_TYPE = (window.ontouchend === null) ? "touchend" : "click";
  // defaultアバターを指し示す名前
  export const DEFAULT_AVATAR_KEY = "__default__";
  // 管理者アバターを指し示す名前
  export const ADMIN_AVATAR_KEY = "__admin__";
  export const SECRET_AVATAR_KEY = "__secret__";
